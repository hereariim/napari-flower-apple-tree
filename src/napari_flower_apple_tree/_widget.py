...
def widget_image_segmentation(
    ...
    image_reshaped,size_ = redimension(layer) #numpy.ndarray
    ...
    #return cv2.resize(temp, dsize=(3024, 4032)) #2e résultat
    return cv2.resize(temp, dsize=(size_[1],size_[0])) #1er résultat
